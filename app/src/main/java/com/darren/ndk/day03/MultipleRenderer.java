...
import com.darren.ndk.day03.opengl.Utils;
...
public class MultipleRenderer implements GLSurfaceView.Renderer {
    ...
    public MultipleRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String fragmentSource = Utils.getGLResource(mContext, mFragmentShader);
