...
public final class CameraHelper implements Camera.PreviewCallback {
    ...
    private CameraDataCallback mDataCakkback;
    ...
    public void open(int cameraId) {
        try {
            ...
            if (mSurfaceTexture != null) {
                ...
                throw new IllegalArgumentException("befor call init");
            }
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        if (mDataCakkback != null){
            mDataCakkback.onPreviewData(data);
        }
    }

    public void setOnPreviewDataCallback(CameraDataCallback callback){
        this.mDataCakkback = callback;
    }
